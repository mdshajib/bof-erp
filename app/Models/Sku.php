...
class Sku extends Model
{
    ...
    protected $fillable = ['id', 'product_id','variation_id', 'purchase_order_id','supplier_id','quantity',
    'is_active','unit','loan','loan_paid','cogs_price','selling_price','created_at', 'updated_at', 'deleted_at'];
