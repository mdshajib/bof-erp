<div>
    ...
    @endsection
    @section('header')
        <x-common.header title="Edit Product">
                        ...
                        <div class="tab-content twitter-bs-wizard-tab-content">
                            <div class="tab-pane {{ $currentStep == 1 ? 'active' : '' }}" id="progress-product-basic-information">
                                ...
                                <ul class="pager wizard twitter-bs-wizard-pager-link">
                                    <li class="next">
                                        <a href="javascript: void(0);" class="btn btn-primary" wire:click="UpdateInfoSubmit">Next <i class="bx bx-chevron-right ms-1"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane {{ $currentStep == 2 ? 'active' : '' }}" id="progress-product-varient">
                                <div>
                                    ...
                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                        ...
                                        <li class="next"><a href="javascript: void(0);" class="btn btn-primary" wire:click.prevent="UpdateVariationSubmit">Next <i class="bx bx-chevron-right ms-1"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                        <li class="previous"><a href="javascript: void(0);" class="btn btn-secondary" wire:click.prevent = "previous(2)"><i
                                                    class="bx bx-chevron-left me-1 fa-color-primary"></i> Previous</a></li>
                                        <li class="float-end"><a href="javascript: void(0);" class="btn btn-primary" wire:click.prevent = "UpdatePriceSubmit">Next <i class="bx bx-chevron-right ms-1"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                        <li class="previous"><a href="javascript: void(0);" class="btn btn-secondary" wire:click="previous(3)"><i
                                                    class="bx bx-chevron-left me-1 fa-color-primary"></i> Previous</a></li>
                                        <li class="float-end">
                                            <button href="javascript: void(0);" class="btn btn-primary"  wire:click="updateMediaSubmit" wire:loading.attr="disabled">
                                                <div wire:loading>
