                ...
                <div class="card-body p-3 order-create">
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <form wire:submit="addRow" name="product_find">
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <div class="form-group has-search">
                                                <span class="fa fa-search form-control-feedback"></span>
                                                <input type="text" class="form-control" id="product_name" placeholder="Product Name" wire:model.defer="product_name" autocomplete="off" />
                                                @error('phone') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    </div>
